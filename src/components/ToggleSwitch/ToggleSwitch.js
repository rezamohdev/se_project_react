...
function ToggleSwitch() {
    ...
    return (
        <label className="switch">
            ...
            <span className={`switch__temp-unit_c ${currentTempratureUnit === 'F' && 'switch__active'}`}>F</span>
            <span className={`switch__temp-unit_f  ${currentTempratureUnit === 'C' && 'switch__active'}`}>C</span>
        </label >
    )
}
