...
function EditProfileModal({ onAddItem, handleCloseModal, isOpen = { isOpen }, buttonText, isLoading }) {
    ...
    return (
        <ModalWithForm isOpen={isOpen} title="Change profile data" onClose={handleCloseModal} name='edit' buttonText={buttonText} onSubmit={handleSubmit}>
            <fieldset className='form__fieldset'>
                ...
                <input id='url' type='url' className='form__input' placeholder='Avatar URL' name="avatar" onChange={handleChange} />
            </fieldset>
        </ModalWithForm >
